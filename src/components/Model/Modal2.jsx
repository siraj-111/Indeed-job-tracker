...
export default function Modal(props) {
  ...
  return (
    <>
       ...
       {/* <Link to={link2}> <span className='mx-3 text-green-500'><i className="fa-solid fa-eye"></i></span></Link> */}
            ...
            <div className="relative flex items-center justify-center min-h-screen w-full">
              ...
              <div className="relative bg-white rounded-lg p-4">
                <div className="p-6 text-center">
                  ...
                  <button data-modal-hide="popup-modal" onClick={closeModal} type="button" className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                    Yes, I'm sure 
                  </button>
